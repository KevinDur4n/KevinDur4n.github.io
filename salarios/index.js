...
function calcularMedianaEmpleados(lista){
...
// var medianaSalarios = calcularMedianaEmpleados(empleados);
// console.log("El promedio de salarios: " + medianaSalarios);

//  Calcular el top 10 % de los salarios. 
var salariosSorted = empleados.map(function(empleados){
...
// console.log(salariosSorted[0] + ":" + salariosSorted[salariosSorted.length-1]);
...
const salariosCountTop10 = salariosSorted.splice(spliceStart,spliceCount);

const medianaTop10Salarios = calcularMedianaEmpleados(salariosSorted);

console.log(medianaTop10Salarios);